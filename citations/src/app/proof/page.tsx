      ...
      <main className="shell receipt-page" id="main">
        ...
        <section className="receipt-proof">
          ...
          <div className="proof-copy">
            ...
            <p className="hero-text">
              ...
              chain health, recorded payment totals, reader-paid queries, source
              inventory, and links into every underlying receipt.
            </p>
            <p className="status-line">
              Sub-cent citations batch into on-chain FeeRouter balances;
              creators claim real USDC anytime.
            </p>
          </div>
        </section>
        ...
        <section className="metrics-band profile-metrics">
          ...
          <div className="metric">
            ...
            <strong>
              {slashBond
                ? formatDollars(slashBond.bondBalance.toString())
                : "$0"}
            </strong>
          </div>
        ...
        <section className="evidence-grid">
          ...
          <div className="evidence-row">
            <span>FeeRouter accrued receipts</span>
          ...
          <div className="evidence-row">
            <span>lifetime slashed across test bonds</span>
            <strong>
              {slashBond
        ...
        {slashBond && (
          <section className="receipt-ledger">
            ...
            <div className="evidence-grid">
              ...
              <div className="evidence-row">
                <span>lifetime slashed across all test bonds</span>
