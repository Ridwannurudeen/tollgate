...
import { projectPublicData, publicLicenseLedger } from "../../lib/public-data";
...
export default async function ProofPage() {
  ...
  const publicLedger = publicLicenseLedger(ledger);
  const creators = projectPublicData(summarizeLedger(ledger));
  const latest = publicLedger.receipts.at(-1);
